Kenzap Gallery
Contributors: kenzap
Tags: Gallery, info, services, about
...
A beautiful and easy customizable set of Gutenberg blocks to create Gallery section for the new editor. Easily adjust the following parameters:

List Gallery as carousel
Assign links
...
2. Type "Kenzap Gallery” into the Search and hit Enter.
3. Locate the Kenzap Gallery plugin in the list of search results and click **Install Now**.
...
1. Download the Kenzap Gallery plugin from WordPress.org.
...
To extend your current theme with Gallery section
...
== Screenshots ==
1. Gallery layout variation 1
2. Gallery layout variation 2
2. Gallery layout variation 3
