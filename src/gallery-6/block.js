...
export const defaultSubBlocks = JSON.stringify( [
    {
        title: '',
        iconMediaId: '',
        icon: window.kenzap_gallery_gutenberg_path + 'block-6/gallery-img-1.jpg',
        iconF: window.kenzap_gallery_gutenberg_path + 'block-6/gallery-img-1.jpg',
        action: 'nothing',
        link: '',
        linkTarget: false,
        ...
        iconMediaId: '',
        icon: window.kenzap_gallery_gutenberg_path + 'block-6/gallery-img-2.jpg',
        iconF: window.kenzap_gallery_gutenberg_path + 'block-6/gallery-img-2.jpg',
        action: 'nothing',
        link: '',
        linkTarget: false,
 ...
 */
registerBlockType( 'kenzap/gallery-6', {
    title: __( 'Kenzap gallery 6', 'kenzap-gallery' ),
