...
{/* 
                        ...
                        />
                        <RangeControl
                            label={ __( 'Description Size', 'kenzap-gallery' ) }
                        ...
                        <PanelColorSettings
                            ...
                            colorSettings={ [
                                ...
                                // {
                                //     value: attributes.descriptionAndFiltersColor,
                                //     onChange: ( descriptionAndFiltersColor ) => {
                                //         return setAttributes( { descriptionAndFiltersColor } );
                                //     },
                                //     label: __( 'Description and filters color', 'kenzap-gallery' ),
                                // },
                ...
                <div className={ `${ className ? className : '' } ` } style={ vars }>
                    <ContainerEdit
                        className={ `kenzap-gallery-8 admin ${ attributes.hoverEffect } ${ attributes.textLocation } ${ attributes.columns === 'default' ? '' : attributes.columns } ${ attributes.displayType } ${ isSelected ? 'selected' : '' } ` }
                                    ...
                                    >
                                        ...
                                        <div className="gallery-box">
                                            ...
                                            <div className="kp-info">
                                                <h3
                                                    style={ { ...getTypography( attributes, 0, 'font-size' ), ...getTypography( attributes, 0, 'line-height' ) 
